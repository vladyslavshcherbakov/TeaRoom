...
export const quietRoom: RoomDefinition = {
  ...
  vessels: [
    ...
    { id: 'caddy', definitionId: 'teaCaddy', initialWaterMl: 0, startsAt: { placeId: 'shelf', x: -2.75, y: 1.22, z: -0.1 } },
  ],
  figurineIds: ['dragon', 'toad'],
  caddyGrams: 60,
  spoonCapacityGrams: 3,
  spoonStartsAt: { placeId: 'teaTable', x: 1.45, y: 0.42, z: -1.3 },
  cloths: [{ id: 'cloth', startsAt: { placeId: 'teaTable', x: 0.5, y: 0.42, z: -1.25 } }],
}
