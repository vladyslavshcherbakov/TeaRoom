...
export function initialSessionState(catalog: Catalog, roomId: string): SessionState {
  ...
  return {
    ...
    heater: { definitionId: room.heaterId, isOn: false, switchedOnAtSeconds: 0, itemIdOnTop: null, secondsHeatedByItemId: {}, secondsWasted: 0, hasAnnouncedTargetTemperature: false, hasAnnouncedBoilingAway: false },
