...
import { eyeHeightMetres, isAKeeperHeight, keeperHeightSteppedBy } from '../../../Apps/Game/Room/Camera/KeeperHeight.ts'
import { assertNear } from '../../Support/Assertions.ts'

test('eyeHeight_ofAKeeperOf200cmStanding_is186cm', () => {
  assertNear(eyeHeightMetres(200, false), 1.86)
})

test('eyeHeight_ofAKeeperOf200cmSeated_is110cm', () => {
  assertNear(eyeHeightMetres(200, true), 1.1)
})
