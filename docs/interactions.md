...
| Tap a vessel with the spoon's hand chosen | The spoon's leaves are tipped into it. Any other item is taken into the free hand. |
...
| Tap the tap or the sink under it with a hand chosen | The keeper holds that hand's vessel under the tap, opening its lid first if the lid must be open to fill, and the water runs. The kettle's water gauge rises. A second tap on the tap, the sink or the vessel under the tap closes it. |
