...
| Stroke the tea table with the cloth's hand chosen | The cloth moves under the finger, and the table is wiped as it goes, so the puddle shrinks while the finger moves. Each 2 cm piece of the stroke is wiped at its own speed, and 1.5 m of strokes cover the whole table. A slow stroke dries more. The cloth darkens as it takes in water and dries again by itself. A tap puts the cloth down, like any item, anywhere it fits. Put down in the puddle, it soaks up a little of it: a wipe at rest over 15% of the table. |
