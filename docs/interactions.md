...
| Tap a rose bush in the garden ten times in a row | The debug menu opens. Any other tap before the tenth starts the count again. The menu switches the camera between the room view and first person, and closes with its Close button. |
| In first person, push the left stick | The keeper walks the way the stick points, at walking speed, only on the room's floor, and slides along the furniture and the walls instead of passing through them. Walking away from a piece of furniture leaves it, and walking stops a walk to furniture that a tap started. |
| In first person, push the right stick | The view turns all the way round, faster the further the stick is pushed, and tilts up and down up to about sixty degrees. |
| In first person, tap anything | The same as in the room view: furniture shows its close-up, and leaving the close-up returns to first person, where the camera faces the way the keeper walked. |
...
| Tap the heater with a hand chosen | The kettle, the thermos or the cloth in that hand goes on the heater. On a working heater the thermos's metal darkens and glows red, and while it glows a tap on it or on its lid leaves it as it is, and the keeper says in one line that it is too hot to take. |
