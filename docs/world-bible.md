...
This is the book of everything the tea room could be. It is inspiration, not a specification. Most of it will never ship, and that is the point. Like a D&D campaign, the world is much larger than what the player sees, and the unseen part is what makes the seen part feel true.

Rules that are already built live in [game-design.md](game-design.md), [interactions.md](interactions.md) and [simulation.md](simulation.md). How hidden memory works is in [world-memory.md](world-memory.md). This file feeds all of them.
...
An idea that answers only the second question is decoration. Decoration is fine, but it goes last.

## Touchstones

These games and ideas shaped the tea room. Each line says what we take from it.

| Source | What we take |
|---|---|
| Fallout 2, Broken Hills and Marcus | A place whose problems grew out of a history the player can feel without being told. |
| Planescape: Torment | Objects and people that carry a past, and a world that reacts to who you are. |
| Arcanum, Morrowind | A world that existed before the player and does not bend around them. |
| Dragon Age: Origins, The Witcher 3 | Small side stories that turn out to be connected to larger ones. |
| Disco Elysium | Objects that talk back through deadpan text, and a world that feels alive because every surface has an opinion. |
| Baldur's Gate 3, Cyberpunk 2077 | Consequences that come back hours later, from a choice the player forgot. |
| Signalis | Questions without answers. The player sees traces and builds the world in their own head. |
| D&D as a game master | Seventy percent of the world is never shown, and it makes the thirty percent convincing. |
| Big Walk (House House, 2026) | Clean, colourful, game-like look. Walking and small tools as the whole game. |
| Untitled Goose Game | Physical comedy from a small, precise set of verbs. |
...
**The world does not wait for the player.** Rain starts whether or not anyone watches. A bird lands on the sill while the player is at the shelf and leaves before they turn around.
...
**The world lives on while the keeper is away.** Coming back is continuing: the keeper finds the room as they left it, but the time away has passed there too. Tea left in a bowl has gone cold, and a kettle left on the heater has boiled dry. The house quietly makes good what would end the tea for good: a burnt spoon is back on the table, and an empty caddy is full again. The keeper notices it in one line. Death is the one thing the house does not undo: after it, the next visit is a new game.
...
- Seiza on tatami, a low table, cushions.
- A western chair at a wooden table.
- On the floor by the window with a tray.
- On the veranda with the doors open. The player cannot leave, but the sky, the garden and the weather are right there.

Where the player sits changes the camera for the ritual, the sounds and what the pets do.
...
## The sky, the weather and the seasons

### Weather

Clear, cloudy, light rain, heavy rain, drizzle, fog, snow, sleet, wind, a storm with distant thunder, a sun shower.
...
- Dawn, morning, day, sunset, dusk, night, with light that shifts slowly.
- The moon in its real phases.
...
- Trees of different kinds: a maple, a pine, a plum. They sway, drip, blossom, turn and go bare.
...
This is the model for how a small secret grows.

1. At first, a sparrow sometimes lands on the sill and leaves.
2. If the window is open at dawn, it stays a little longer.
3. If the bird figurine is offered tea, the sparrow comes more often.
4. After many offerings and open mornings, it hops inside onto the table and looks at the bowl.
5. Much later, it lands on the keeper's shoulder while they drink.
6. If the player closes the window on it, it does not come for three days. Nothing says why.

The player never sees these steps listed. They only notice the bird getting bolder.
...
### Descriptions, not only names

Each tea has a short description in the voice of a label written by someone who loves it:

- "Grassy and bright. Drink it in the morning, before anyone asks you anything."
- "Roasted, a little smoky. An autumn tea."
- "Dark, earthy, patient. It has waited longer than you have."
- "Soft and floral. It forgives slightly cool water."

From the description the player learns whether a tea is calming, waking, seasonal or forgiving, without a stat.

### Infusions

In gongfu brewing, the same leaves are steeped many times. Real behaviour, and ours:
...
- Used bowls go to the counter by the sink or into the sink. Both have limited room.
- When they are full, the player has to wash.
- Washing is tactile: the player aims the stream of the tap at a bowl and sweeps it. The wet, clean area shows where the water went. A missed spot stays dull.
- A cloth dries them. A damp bowl put back on the shelf leaves a ring.

### Drinking from a dirty bowl

The game hints with dry text during the sip:

- "There is an aftertaste of yesterday."
- "The tea tastes faintly of the tea before it."
- "The gods look away, politely."
- "A small leaf from last time says hello."

### Breaking and kintsugi
...
- The kettle's handle darkens where it is always held.
...
- "The temperature is perfect. The gods are content."
- "Two degrees too hot. The gods pretend not to notice."
- "The tea is oversteeped. Very oversteeped."
- "You poured tea past the bowl. We will tell no one."
- "The cat sat on the towel. The towel now belongs to the cat."
- "The gods understand. Probably."
- "There is an aftertaste of yesterday."
- "The rug is crooked. The cat approves."
- "The toad has opinions about the weather."
- "The record has ended. The room keeps listening."
...
Write it in this form before building it:
...
- **Never told.** What the player will never be told about it.
