...
**The kettle shows its water in a glass gauge on its side.** The kettle is clay and opaque. A gauge window, as on many kettles, shows the level from any side without opening the lid.
