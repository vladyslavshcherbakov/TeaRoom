...
echo "Building the room without logs into dist-artifact/"
npx --no-install vite build Apps/Game/Room --mode silent --base ./ --outDir ../../../dist-artifact/build --emptyOutDir --logLevel warn
