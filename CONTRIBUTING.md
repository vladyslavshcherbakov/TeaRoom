...
- `Room/Placement.ts` decides whether an item fits where the player tapped. An item standing on furniture is turned by `turnOfItemsOn` in `Room/RoomLayout.ts`, and whatever places or draws it uses that turn.
