...
2. Run the tests. `Tests/Content/DefaultCatalog.unit.test.ts` checks references and ranges, and `Tests/Content/TeaBalance.integration.test.ts` brews every tea by the book.
