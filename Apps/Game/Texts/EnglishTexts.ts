export const englishTexts = {
  ...
  'settings.glow': 'Glow of lamps and hot metal',
  'settings.glowWarning': 'Lamps, embers and red-hot metal shine into the room around them, but the game may start to lag on some phones.',
