export const englishTexts = {
  ...
  'spoonCrumbled.2': 'Ash. That was bamboo a minute ago. Next time the spoon stays off the heater.',
  'spoonCrumbled.3': 'Well, that settles the tea for today. Try getting leaves out of the caddy with your fingers.',
  'spoonCrumbled.4': 'The spoon has left us. Plain hot water for now, and a lesson for next time.',
