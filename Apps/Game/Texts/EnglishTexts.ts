export const englishTexts = {
  ...
  'obituary.1': 'Here lies the keeper, who brewed the whole caddy at once and sipped it straight from the tin. Survived by ten tea bowls and a thermos.',
  'obituary.2': 'In loving memory of the keeper. Cherished by the dragon and the toad, undone by one caddy of tea.',
  'obituary.3': 'The keeper left us today, strong to the end, like their tea. In lieu of flowers, please send a smaller caddy.',
  'obituary.4': 'Here rests the keeper. They wanted a stronger cup. They got one.',
