export const englishTexts = {
  ...
  'spoonReturned.4': 'A new spoon is waiting on the tea table. Let us not introduce it to the heater.',
  ...
  'spoonAndCaddyReturned.1': 'A new spoon on the table and a full caddy. Let us try not to burn one or rinse the other.',
